...
export const valuesToTestPrimitive: IValue[] = [
  ...
  {
    value: { testString: "testy", testNumber: 5.5, testBoolean: false },
    result: false,
  },
];
...
export const valuesToTestArrayOf: IValue[] = [
  ...
  {
    value: [{ testString: "testy", testNumber: 5.5, testBoolean: false }, 5],
    result: false,
    inner: Is.object,
  },
  {
    value: [{ testString: "testy", testNumber: 5.5, testBoolean: false }, true],
    result: false,
    inner: Is.object,
  },
];
